<h3>Faculty - Elizabeth Smith</h3>
    <div id="leftcolumn">
        <div id="summary_box">
            <img src="../images/smith.jpg" height="200" width="150" alt="Elizabeth Smith" />
            <div id="summary_text">
                <h4>Elizabeth Smith, <span class="title">Assistant  Professor</span></h4>
                <ul>
                    <li><abbr>Ph.D.</abbr>, New York University, 2006</li> 
                    <li><a href="documents/SmithCV.pdf">Curriculum Vitae</a></li>
                </ul>
            <h6>Area of expertise</h6>
                <p>Cultural anthropology, nationalism, race and ethnicity, tourism and museums, gender, visual anthropology, photography, representation of Nubians in popular culture; Egypt, Middle East.</p>
              ...
              Williams Hall, Room 514</p>
                <p><strong>Website:</strong> <a href="/~esmith6/">Faculty Website</a></p>
            </div>
        </div>
