    ...
    <div id="leftcolumn">
        <div id="summary_box">
            <img src="../images/manetta.jpg" height="200" width="150" alt="Emily Manetta" />
            <div id="summary_text">
                <h4>Emily Manetta, <span class="title">Associate Professor</span></h4>
                <ul>
                    <li><abbr>Ph.D.</abbr>, University of California, Santa Cruz, 2006</li>
                    <li><a href="documents/ManettaCV.pdf">Curriculum Vitae</a></li>
                </ul>
              ...
              Williams Hall, Room 514</p>
                <p><strong>Website:</strong> <a href="/~emanetta/">Faculty Website</a></p>
            </div>
        </div>
