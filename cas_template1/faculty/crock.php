<h3>Faculty - John Crock</h3>
    <div id="leftcolumn">
        <div id="summary_box">
            ...
            <div id="summary_text">
                <h4>John Crock, <span class="title">Associate Professor and Director of Consulting Archaeology Program</span></h4>
                <ul>
                    <li><abbr>Ph.D.</abbr>, University of Pittsburgh, 200<abbrev>0</abbrev></li> 
                    <li><a href="documents/CrockCV.pdf">Curriculum Vitae</a></li>
                </ul>
