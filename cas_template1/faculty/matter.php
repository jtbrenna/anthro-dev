<h3>Scott Matter </h3>
    <div id="leftcolumn">
        <div id="summary_box"><img src="../images/matter.jpg" alt="Gordon" width="150" height="200">
          <div id="summary_text">
            <h4>Scott Matter, Lecturer</h4>
                  <ul>
                    <li><abbr>Ph.D.</abbr>, McGill University, 2011</li> 
                  </ul>
              <h6>Area of expertise</h6>
                  <p>Political  and environmental anthropology, cultural politics, political ecology;  ethnicity, inequality, land tenure, political representation, patronage,  indigenous rights, forestry and conservation, pastoralism, foragers and former  foragers, Maasai, Dorobo; Kenya, Africa </p>
