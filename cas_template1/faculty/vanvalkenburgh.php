    ...
    <div id="leftcolumn">
        <div id="summary_box">
            <img src="../images/vanvalkenburgh.jpg" height="200" width="150" alt="Parker VanValkenburgh" />
            <div id="summary_text">
                <h4>Parker VanValkenburgh, <span class="title">Assistant Professor</span></h4>
                <ul>
                    <li><abbr>Ph.D.</abbr>, Harvard University, 2012</li>
                </ul>
              <h6>Area of expertise</h6>
                <p>political dimensions of landscapes, built environments, and human subjectivities</p>
                <h6>Contact Information</h6>
                <p>501 Williams Hall<br>
                  (802) 656-8219
                </p>
                <address>
                    <strong>Email:</strong> <a href="mailto:Nathaniel.VanValkenburgh@uvm.edu">Nathaniel.VanValkenburgh@uvm.edu</a>
              </address>
                <p><strong>Office Hours:</strong> Tuesday, 1:00-2:30, and Thursday, 1:00-2:00; or by appointment</p>
            </div>
        </div>
        <p>Parker VanValkenburgh, Assistant Professor of Anthropology, grew up in Tulsa, Oklahoma and studied anthropology as an undergraduate at Stanford University (BA, 2003), before pursuing advanced degrees at the University of Cambridge (M.Phil, Archaeology, 2004), the University of London (M.A., Latin American Studies, 2005), and Harvard University (Ph.D., Anthropology, 2012). Prior to joining UVM, he was Andrew Mellon Postdoctoral Fellow in Modeling Interdisciplinary Inquiry at Washington University in St. Louis.</p>
