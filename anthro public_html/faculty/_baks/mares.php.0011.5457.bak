    ...
    <div id="leftcolumn">
        <div id="summary_box">
          ...
          <div id="summary_text">
                ...
                <ul>
                    <li><abbr>Ph.D.</abbr>, University of Washington, 2010</li>
                    <li><a href="documents/MaresCV.pdf">Curriculum Vitae</a></li>
                </ul>
            ...
            <span class="style2"><strong>Email:</strong> <a href="mailto:teresa.mares@uvm.edu">Teresa Mares</a><br />
                ...
                <address>
                <em>                <strong>Office Hours:</strong>   by appointment<br />
                Williams Hall, Room 501                    </em>
            </address>
          </div>
      </div>
