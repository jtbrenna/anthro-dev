<h3>Faculty - John Crock</h3>
    <div id="leftcolumn">
        <div id="summary_box">
            <img src="../images/crock.jpg" height="200" width="150" alt="John Crock" />
            <div id="summary_text">
                <h4>John Crock, <span class="title">Assistant Professor</span></h4>
                <ul>
                    <li><abbr>Ph.D.</abbr>, University of Pittsburgh, 2000</li> 
                    <li>Director of <abbr>UVM</abbr>'s Vermont Consulting Archaeology Program</li>
                </ul>
            <h6>Area of expertise</h6>
                <p>Specializing in cultural resource management studies required by state and federal regulations.</p>
                ...
                Delehanty Hall, Trinity Campus</p>
                <p><strong>Website:</strong> <a href="/~uvmcap/">Consulting Archaeology Program</a></p>
            </div>
        </div>
