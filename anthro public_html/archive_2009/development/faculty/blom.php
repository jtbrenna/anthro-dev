<h3>Faculty - Deborah Blom</h3>
    <div id="leftcolumn">
        <div id="summary_box">
            ...
            <div id="summary_text">
                <h4>Deborah Blom, <span class="title">Associate Professor </span></h4>
                <ul>
                    <li><abbr>Ph.D.</abbr>, University of Chicago, 1999</li>            
                </ul>
            <h6>Area of expertise</h6>
                <p>Archaeology, osteology, ethnicity, body adornment, social complexity; Andean South America. [<a href="/~dblom/DBlomCV.html"><strong><abbr>C.V.</abbr></strong></a>]</p>
                ...
                <p><strong>Website:</strong> <a href="/~dblom/">Faculty website</a></p>
            </div>
        </div>
